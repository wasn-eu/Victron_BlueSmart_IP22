...
#define MQTT_CLIENT_ID      "Victron_BlueSmart_%x"
#define MQTT_SUBTOPIC_VOLTAGE  "voltage"
#define MQTT_SUBTOPIC_CURRENT  "current"
...
#define MQTT_TOPIC_DISCOVER "homeassistant/sensor/victron-bluesmart-"
